...
predictions_dict, top_class, top_probability = predict("test_pic.jpg")

print("Top class:", top_class)
print("Probability:", top_probability)

print("\nTop 5 predictions:")
for cls, prob in sorted(predictions_dict.items(), key=lambda x: x[1], reverse=True)[:5]:
